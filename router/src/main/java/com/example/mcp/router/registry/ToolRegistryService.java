 ...
 * {@link com.example.mcp.router.config.ToolRegistryConfig}); in the production
 * architecture this is where a DynamoDB (or Aurora) lookup would go, keyed by tool
 * name, with the same public contract so {@link com.example.mcp.router.protocol.McpProtocolService}
